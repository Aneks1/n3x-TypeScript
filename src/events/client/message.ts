...
const messageEvent = new Event({
    ...
    run: async function(message: Message) {
        ...
        } else if (message.guild && message.channel.id == '743822809410830400' || message.guild && message.channel.id == '769227400969191444' || message.guild && message.channel.id == '810899508518060033' || message.guild && message.channel.id == '744288105300885554') {
